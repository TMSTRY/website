      ...
      {show && (
        ...
        >
          ...
          <div className="flex items-center gap-3 p-3">
            <span className="relative w-10 h-10 flex-shrink-0 overflow-hidden border border-white/10">
              <Image key={track.cover} src={track.cover} alt="" fill sizes="40px" className="object-cover" />
            </span>
